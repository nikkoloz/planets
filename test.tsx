function ss() {
  return (
    <section className="relative z-10 mx-auto max-w-[1640px]">
      ...
      sm1:order-3 sm1:w-1/2 sm1:flex-col sm1:justify-start sm1:gap-4 sm1:border-0 sm1:pr-10 
      sm1:text-mex sm2:absolute sm2:top-[390px] sm2:right-[66px]  sm2:w-[350px] sm2:pr-0 sm3:top-[470px] sm3:right-[170px] "
        >
          <button
      ...
      <div className="mx-6 sm1:mx-10 sm1:flex sm1:gap-3  sm2:mx-[90px] sm2:gap-8 sm3:mx-[170px]">
        <div className="mb-2 flex items-center justify-between border-[1px] border-white border-opacity-[0.2] px-6 py-4 sm1:w-full sm1:flex-col sm1:gap-[6px] sm2:gap-1 sm2:px-[23px] sm2:py-[20px]">
